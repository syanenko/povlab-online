...
blob{
  ...
  #for(I,0,N-1)
    ...
    //cylinder{<0,0,0>,<0,+1,0>,0.03,+0.8 Point_At_Trans(Normal) translate Normal*Distance*1.0}
...
light_source{< -300, 3000,   0> rgb <0.3,0.3,0.3>}
light_source{< 3000,  300,-500> rgb .5}
light_source{<  300,-3000,   0> rgb <0.2,0.2,0.3>}
